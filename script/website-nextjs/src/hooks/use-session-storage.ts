...
import { sessionStorageGetItem } from '@/utils/storage-available'
...
export function useSessionStorage<T>(key: string, initialState: T): UseSessionStorageReturn<T> {
...
export function getStorage(key: string) {
  try {
    const result = sessionStorageGetItem(key)
