  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <div role="button" className="relative size-5 rounded-full bg-yile-600">
          <ChevronDownIcon className="absolute top-[55%] left-1/2 -translate-x-1/2 -translate-y-1/2 size-4 text-white" />
        </div>
